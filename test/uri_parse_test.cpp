...
{
    std::string_view view = uri.uri_view();
    auto b = view.begin();
    auto e = view.end();
...
static bool check_uri(const URI& uri, std::string_view uri_view, std::string_view scheme,
                      std::string_view user_info, std::string_view host, std::string_view port_view,
                      uint16_t port, std::string_view path, std::string_view query, std::string_view fragment)
{
